...
const styles = StyleSheet.create({
  ...
  back: { color: Colors.parentAccent, fontSize: 16, fontWeight: '600', width: 60 },
  ...
  tabActive: { backgroundColor: Colors.parentAccent },
  ...
  addBtn: {
    backgroundColor: Colors.parentAccent, borderRadius: 14,
  ...
  codeCard: {
    ...
    borderWidth: 2, borderColor: Colors.parentAccent,
    shadowColor: Colors.parentAccent, shadowOffset: { width: 0, height: 3 }, shadowOpacity: 0.12, shadowRadius: 8, elevation: 3,
  },
  ...
  emailBadgeValue: { fontSize: 13, fontWeight: '700', color: Colors.parentAccent },
  code: { fontSize: 36, fontWeight: '900', color: Colors.parentAccent, letterSpacing: 6, marginBottom: 4, textAlign: 'center' },
  codeParent: { color: '#FF9500' },
  expiry: { fontSize: 12, color: Colors.textMuted, marginBottom: 14, textAlign: 'center' },
  actionRow: { flexDirection: 'row', gap: 8, alignItems: 'center' },
  shareBtn: {
    flex: 1, backgroundColor: Colors.parentAccent, paddingVertical: 10,
    borderRadius: 10, alignItems: 'center',
  },
  shareBtnParent: { backgroundColor: '#FF9500' },
  resendBtn: {
    flex: 1, backgroundColor: Colors.parentAccent + '22', paddingVertical: 10,
    borderRadius: 10, alignItems: 'center', borderWidth: 1, borderColor: Colors.parentAccent,
  },
  cancelBtn: {
  ...
  keepBtn: {
    flex: 1, backgroundColor: Colors.parentAccent + '18', paddingVertical: 10,
    borderRadius: 10, alignItems: 'center',
  },
  keepBtnText: { color: Colors.parentAccent, fontWeight: '700', fontSize: 13 },
  confirmCancelBtn: {
    flex: 1, backgroundColor: '#FF3B30', paddingVertical: 10,
    borderRadius: 10, alignItems: 'center',
  },
  confirmCancelBtnText: { color: '#fff', fontWeight: '700', fontSize: 13 },
  actionBtnText: { color: Colors.parentAccent, fontWeight: '700', fontSize: 13 },
  ...
  createBtn: {
    backgroundColor: Colors.parentAccent, paddingHorizontal: 32, paddingVertical: 14,
